...
(async () => {
  ...
  for (let i = 0; i < uniqueNames.length; i++) {
    ...
    // First, find the product ID for this name to use as filename
    ...
    const clean = name.replace(/\s*(100g|200g|50g|25g|250g|500g|1kg|bags|sachet|pack|150g|80g|30g|45g|300g|75g)/gi, '').trim();
