    ...
    <>
      ...
      {!isSearching && (
        <button
          ...
          className="md:hidden fixed top-3 right-3 z-50 w-10 h-10 flex items-center justify-center bg-white/90 backdrop-blur-sm border border-slate-200/80 text-slate-700 rounded-xl shadow-md hover:bg-white hover:shadow-lg active:scale-95 transition-all duration-150"
        >
